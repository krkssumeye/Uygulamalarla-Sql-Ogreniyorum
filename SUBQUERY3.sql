USE ETRADE4
---ÜRÜN HANGÝ AYDA EN ÇOK SATILDI
...
--WHERE (SELECT MIN(UNITPRICE) FROM ORDERDETAILS WHERE ITEMID=ITM.ID) IS NULL --BOÞ OLAN KOLONLARI GETÝRDÝK
WHERE ITM.ID NOT IN 
(SELECT ITEMID FROM ORDERDETAILS)  --BU ÞEKÝLDEDE GETÝREBÝLÝRÝZ 
